...
public class TasksController : ControllerBase
{
    ...
    // ETAPA 2 — Retorna apenas as tarefas do próprio usuário
    [Authorize]
    [HttpGet]
    ...
    // ETAPA 2 — Cria uma tarefa vinculada ao usuário logado
    [Authorize]
    [HttpPost]
    ...
    // ETAPA 3 — Apenas Admins podem deletar (Policy: CanDeleteTask)
